      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          <div class="col-md-12" style="margin-bottom: 15px;">
            <a href="AddOrEditStudent" class="btn btn-theme start">
              <i class="fa fa-plus"></i>
              <span> Thêm tài khoản SV</span>
            </a>
          </div>
                ...
                <tbody>
                  <c:forEach items="${listSV}" var="sv">
                    <tr>
                      ...
                      <td>${sv.email}</td>
                      <td>
                        <a href="AddOrEditStudent?editStuID=${sv.masv}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                        <a href="ListStudents?deleteStuID=${sv.masv}"class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                      </td>
                    </tr>
                  </c:forEach>  
                </tbody>
