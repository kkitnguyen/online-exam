    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll active" href="ExamSchedules">Lịch thi</a>
                </li>
                <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <h2><span class="turquoise">Lịch thi của bạn</span></h2>
                                        ...
                                        <form action="doExam" method="POST">
                                            <tr>
                                                ...
                                                <td> 
                                                    ...
                                                    <button type="submit" class="btn btn-success" style="padding: 2px 7px;"> Làm bài thi </button>
                                                </td>
                                            </tr>
                                        </form>
                                    </c:forEach>  
