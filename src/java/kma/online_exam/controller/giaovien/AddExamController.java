 ...
 * @author KK
 */
@WebServlet(name = "AddExamController", urlPatterns = {"/AddExam"})
public class AddExamController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("views/giaovien/addExam.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dedao.insertDethi(dethi)){
                System.out.println("Da them 1 de thi");
            }else{
                System.out.println("Them de thi that bai");
            }
